...
namespace Evel.gui {
    public partial class MainForm : Form {
        ...
        internal ProjectForm baloonProjectForm;
        ...
        void ReadRegistry() {
            ...
            int localFreeColor = (int)Registry.GetValue(_registryGUIKeyName, "LocalFreeColor", Color.FromArgb(0xC2, 0xE4, 0x74).ToArgb());// Color.YellowGreen.ToArgb());
            int localFixedColor = (int)Registry.GetValue(_registryGUIKeyName, "LocalFixedColor", Color.FromArgb(0xE1, 0xA3, 0x9F).ToArgb()); // Color.IndianRed.ToArgb());
            int commonFreeColor = (int)Registry.GetValue(_registryGUIKeyName, "CommonFreeColor", Color.FromArgb(0x6D, 0xE8, 0x60).ToArgb()); // Color.MediumSeaGreen.ToArgb());            
            int commonFixedColor = (int)Registry.GetValue(_registryGUIKeyName, "CommonFixedColor", Color.FromArgb(0xED, 0x87, 0x87).ToArgb()); //Color Color.Red.ToArgb());
            int bindedFixedColor = (int)Registry.GetValue(_registryGUIKeyName, "BindedFixedColor", Color.FromArgb(0xfd, 0xc8, 0x4a).ToArgb()); //Color Color.Red.ToArgb());
            int bindedFreeColor = (int)Registry.GetValue(_registryGUIKeyName, "BindedFreeColor", Color.FromArgb(0x4a, 0xd0, 0xfd).ToArgb()); //Color Color.Red.ToArgb());
            StatusColors.Add(ParameterStatus.Local | ParameterStatus.Free, Color.FromArgb((int)localFreeColor));
            StatusColors.Add(ParameterStatus.Local | ParameterStatus.Fixed, Color.FromArgb((int)localFixedColor));
            StatusColors.Add(ParameterStatus.Common | ParameterStatus.Free, Color.FromArgb((int)commonFreeColor));
            StatusColors.Add(ParameterStatus.Common | ParameterStatus.Fixed, Color.FromArgb((int)commonFixedColor));
            StatusColors.Add(ParameterStatus.Binding | ParameterStatus.Free, Color.FromArgb((int)bindedFreeColor));
            StatusColors.Add(ParameterStatus.Binding | ParameterStatus.Fixed, Color.FromArgb((int)bindedFixedColor));
        }
        ...
        private void notifyIcon_BalloonTipClicked(object sender, EventArgs e) {
            ...
            this.Activate();            
            if (this.baloonProjectForm != null) {
                //this.baloonProjectForm.Show();
                //this.baloonProjectForm.Activate();
                this.baloonProjectForm.projectTabControl.SelectedTab = this.baloonProjectForm.SearchTabPage;
            }
        }
